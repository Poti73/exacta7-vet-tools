...
export function AuthForm({ nextPath = '/cuenta' }: { nextPath?: string }) {
  ...
  if (!hasSupabasePublicConfig()) return <section className="panel narrow"><h1>Acceso en preparación</h1><p>La autenticación todavía no está disponible en este entorno.</p></section>;
