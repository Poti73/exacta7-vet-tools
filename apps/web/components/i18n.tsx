...
const copy = {
  es: {
    skip:'Saltar al contenido', navMedicines:'Vademécum', navTools:'Herramientas', navSources:'Fuentes', navAbout:'Sobre Exacta7', navContact:'Contacto', privacy:'Privacidad', navLabel:'Navegación principal', home:'inicio',
  ...
  en: {
    skip:'Skip to content', navMedicines:'Formulary', navTools:'Tools', navSources:'Sources', navAbout:'About Exacta7', navContact:'Contact', privacy:'Privacy', navLabel:'Main navigation', home:'home',
  ...
  fr: {
    skip:'Aller au contenu', navMedicines:'Formulaire', navTools:'Outils', navSources:'Sources', navAbout:'À propos', navContact:'Contact', privacy:'Confidentialité', navLabel:'Navigation principale', home:'accueil',
