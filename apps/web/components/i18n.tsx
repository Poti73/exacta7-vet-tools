...
const copy = {
  es: {
    skip:'Saltar al contenido', navMedicines:'Vademécum', navTools:'Herramientas', plans:'Planes', navSources:'Fuentes', navAbout:'Sobre Exacta7', navContact:'Contacto', privacy:'Privacidad', cookies:'Cookies', navLabel:'Navegación principal', home:'inicio',
    ...
    groupMedicines:'MEDICAMENTOS', groupCalculators:'CALCULADORAS', groupTools:'HERRAMIENTAS', groupReferences:'REFERENCIAS',
    regulatoryProduct:'Producto AEMPS/CIMA Vet',
  },
  en: {
    skip:'Skip to content', navMedicines:'Formulary', navTools:'Tools', plans:'Plans', navSources:'Sources', navAbout:'About Exacta7', navContact:'Contact', privacy:'Privacy', cookies:'Cookies', navLabel:'Main navigation', home:'home',
    ...
    groupMedicines:'MEDICINES', groupCalculators:'CALCULATORS', groupTools:'TOOLS', groupReferences:'REFERENCES',
    regulatoryProduct:'AEMPS/CIMA Vet product',
  },
  fr: {
    skip:'Aller au contenu', navMedicines:'Formulaire', navTools:'Outils', plans:'Formules', navSources:'Sources', navAbout:'À propos', navContact:'Contact', privacy:'Confidentialité', cookies:'Cookies', navLabel:'Navigation principale', home:'accueil',
    ...
    groupMedicines:'MÉDICAMENTS', groupCalculators:'CALCULATEURS', groupTools:'OUTILS', groupReferences:'RÉFÉRENCES',
