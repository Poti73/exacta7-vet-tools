...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = ['', '/medicamentos', '/calculadoras', '/planes', '/fuentes', '/fuentes/actualizaciones-aemps', '/sobre-exacta7', '/contacto', '/comparar', '/comparar/exacta7-vs-cima-vet', '/comparar/exacta7-vs-plumbs', '/comparar/exacta7-vs-vin', '/alternativas/plumbs', '/para/estudiantes-veterinaria', '/para/veterinarios', '/aviso-legal', '/terminos', '/privacidad', '/cookies'];
  return [
