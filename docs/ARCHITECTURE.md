...
Ver SEARCH-ARCHITECTURE.md para indexación, publicación y propuesta de backend. La app incluye endpoint /api/health. Robots noindex para esta versión sin revisión; no se genera sitemap clínico de fichas vacías.
